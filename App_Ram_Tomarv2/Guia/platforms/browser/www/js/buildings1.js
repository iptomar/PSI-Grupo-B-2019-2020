...
navigator.geolocation.getCurrentPosition(function (location) {
    ...
    //Fazer fetch do api do endpoints do servidor que neste caso é api/buildings
    fetch('http://psi2020.tugamars.com/api/buildings')
        .then((res) => { return res.json() })
        .then((data) => {
            //Buscar os dados do array
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content pontoInter" style="height:300px; width:300px;overflow:scroll;">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-info btn-lg" onclick="pontInteresse()">Ver detalhes</button>
                                    </div><br>
                                </div>
                            </div>
                            </div>`).addTo(mymap);
